...
const cards = [
  {
    ...
    meta: "53 Street, Al Garhoud ,Dubai United Arab Emirates.",
  ...
  },
  {
    ...
    meta: "Consultant Pediatrician, Al Garhoud ,Dubai United Arab Emirates, 0505870574",
    // desc: "Delivering specialized pediatric care with years of clinical expertise.",
    showButton: false,
  },
  {
    ...
    phone: "0505870574",
    email: "seemagauravansh@gmail.com", // Replace with your actual email
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-slate-400">
            Beautiful modern cards with premium interactions and responsive
            layout.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-full rounded-[31px] bg-slate-900/95 p-8 backdrop-blur-xl">
                  ...
                  <Icon
                    className="absolute right-4 top-4 h-32 w-32 text-white/5 transition duration-500 group-hover:scale-110"
                    strokeWidth={1}
                  />
                  ...
                  {/* Location / Practice */}
                  {card.meta && (
                    <p className="mt-2 text-cyan-300">{card.meta}</p>
                  )}
                  ...
                  {card.phone && (
                    <div className="mt-4 space-y-3">
                      <a
                        href={`tel:${card.phone}`}
                        className="flex items-center gap-3 text-cyan-300 transition-colors hover:text-cyan-200"
                      >
                  ...
                  {card.showButton && (
                    <motion.a
                      whileHover={{ x: 5 }}
                      href={card.href}
                      className="mt-10 flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-5 py-4 text-white transition-all hover:bg-white/10"
                    >
                  ...
                  {/* Bottom Glow */}
                  <div
                    className={`absolute -bottom-20 left-1/2 h-44 w-44 -translate-x-1/2 rounded-full bg-gradient-to-r ${card.color} opacity-20 blur-[90px] transition duration-500 group-hover:opacity-40`}
                  />
                </div>
              </motion.div>
            );
